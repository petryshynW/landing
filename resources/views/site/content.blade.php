        ...
        <div class="portfolio">
            ...
            <div class="isotope fadeInLeft animated wow" style="position: relative; overflow: hidden; height: 480px;" id="portfolio_wrapper">
                @foreach($portfolio as $portfolioItem)
                    <!-- Portfolio Item -->
                    <div style="position: absolute; left: 0px; top: 0px; transform: translate3d(0px, 0px, 0px) scale3d(1, 1, 1); width: 337px; opacity: 1;" class="portfolio-item one-four   {{$portfolioItem->filter}} isotope-item">
                        <div class="portfolio_img"> <img src="{{asset('assets/img/'.$portfolioItem->images)}}"  alt="{{$portfolioItem->name}}"> </div>
                        <div class="item_overlay">
                            <div class="item_info">
                                <h4 class="project_name">{{$portfolioItem->name}}</h4>
                            </div>
                        </div>
                    </div>
                    <!--/Portfolio Item -->
